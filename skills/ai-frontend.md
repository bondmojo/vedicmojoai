...
| [chart-visualization.md](frontend/chart-visualization.md) | 18 compute components (North/South Indian, Grahas, Gochar, Bindu, Yogas, etc.) + shared modules |
| [gochar.md](frontend/gochar.md) | Current transit diagrams, UTC Gochar ranges, PD expansion, and client-safe request conventions |
