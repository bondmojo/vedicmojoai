...
| Chart Visualization | 18 compute components (North/South Indian, Grahas, Gochar, Bindu, Yogas, Ashtakavarga, etc.) |
...
| `chart-visualization.md` | 18 compute components (North/South Indian, Grahas, Gochar, Bindu, Yogas, etc.) + shared modules |
